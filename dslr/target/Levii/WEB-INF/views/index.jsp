		...
		<div id="myCarousel" class="carousel slide" data-ride="carousel">
			...
			<div class="carousel-inner">
				<div class="item active">
					<img src="./resources/images/cam12.jpg" alt="" style="width: 100%;"
						style="height:80%">
				</div>

				<div class="item">
					<img src="./resources/images/cam9.jpg" alt="" style="width: 100%;"
						style="height:50%">
				</div>

				<div class="item">
					<img src="./resources/images/cam10.jpg" alt="" style="width: 100%;"
						style="height:50%">
				</div>
			</div>
